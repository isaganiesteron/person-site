...
export default function Home() {
	return (
		<>
			{/* Hero Section */}
			<section className="container mx-auto flex flex-col items-center justify-center gap-6 px-2 pb-8 pt-16 md:pb-12 md:pt-24 lg:py-32">
				<div className="mx-auto flex max-w-[980px] flex-col items-center gap-4 text-center">
					<h1 className="text-3xl font-bold leading-tight tracking-tighter md:text-6xl lg:leading-[1.1]">
						Build beautiful websites faster with our
						<span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent"> modern stack</span>
					</h1>
					<p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">A production-ready template built with Next.js 14, TypeScript, and Tailwind CSS. Start your next project with our beautifully designed components.</p>
				</div>
			...
			{/* Features Section */}
			<section className="container mx-auto space-y-6 bg-orange-50/50 py-8 dark:bg-orange-900/10 md:py-12 lg:py-24">
